...
export default function Home(props) {
 ...
 <>
      ...
      <div className="lg:w-full reno:w-full md:w-full sm:w-screen xs:w-screen xxs:w-screen p-6 h-1/4">
        ...
        <br />
        <h4 className="text-lg text-center text-subheading lg:w-1/3 reno:w-1/3 md:w-1/3 sm:w-full xs:w-full xxs:w-full my-0 mx-auto"  >
      ...
      >
        ...
        <div className="lg:w-1/2 relative space-y-10 md:p-20 reno:p-20 lg:p-20 sm:p-6 xs:p-6 xxs:p-6 md:w-full reno:w-full sm:w-screen xs:w-screen xxs:w-screen grid place-items-center"  >
      ...
      {/* Partner Section */}
      <div className="bg-blue-100 p-10 py-14"   id="partners">
        <div
