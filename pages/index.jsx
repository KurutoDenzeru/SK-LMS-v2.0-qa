...
export default function Home(props) {
	...
	useEffect(() => {
		if (validToken && !validToken.success) dispatch(UserLogout(false));
	}, [validToken]);
	...
	return (
		<>
          ...
          font-semibold"
				...
				<br />
				<h4
					className="text-lg text-center text-subheading lg:w-1/3 reno:w-1/3 md:w-1/3 sm:w-full xs:w-full xxs:w-full my-0 mx-auto"
					data-aos="fade-up"
				>
			...
			<div
				className="md:w-full xs:w-screen xxs:w-screen md:flex-row xs:flex-col xxs:flex-col p-6 h-1/4 flex items-center"
				data-aos="fade-right"
			...
			<div
				className="md:w-full xs:w-screen xxs:w-screen md:flex-row xs:flex-col-reverse xxs:flex-col-reverse p-6 h-1/4 flex items-center"
				data-aos="fade-left"
			>
			...
			<div
				className="md:w-full md:flex-row xs:w-screen xxs:w-screen xs:flex-col xxs:flex-col p-6 h-1/4 flex items-center"
				data-aos="fade-right"
			>
			...
			>
				...
				<div
					className="lg:w-1/2 relative space-y-10 md:p-20 reno:p-20 lg:p-20 sm:p-6 xs:p-6 xxs:p-6 md:w-full reno:w-full sm:w-screen xs:w-screen xxs:w-screen grid place-items-center"
					data-aos="fade-up"
					data-aos-anchor-placement="top-center"
				>
			...
			<div
				id="testimonial"
				className="lg:w-full md:w-full reno:w-full sm:w-screen xs:w-screen xxs:w-screen space-y-14 md:mt-32 reno:mt-32 lg:mt-16 mb-10"
				data-aos="slide-up"
			>
				<h1 className="text-center w-full lg:text-6xl md:text-6xl reno:text-6xl sm:text-4xl xs:text-4xl xxs:text-4xl font-semibold text-heading md:mt-32 reno:mt-32 lg:mt-16">
					From Our Partners
			...
			{/* Partner Section */}
			<div
				className="bg-blue-100 p-10 py-14"
				data-aos="zoom-in-up"
				id="partners"
			>
				<div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-2xl lg:px-6">
					<h1 className="text-center my-auto lg:text-center font-bold text-4xl sm:text-5xl leading-none mb-6">
						Our Partners
					</h1>
					...
					<div className="flex flex-wrap justify-center items-center mt-16 text-gray-500 sm:justify-between">
						<img
							className="ml-10 mr-5 mb-5 w-28 transform hover:bg-transparent transition duration-500 hover:scale-105"
						...
						<img
							className="ml-10 mr-5 mb-5 w-20 transform hover:bg-transparent transition duration-500 hover:scale-105"
			...
			>
				<section className="bg-white pt-24 px-8">
					<div className="mx-auto px-8 max-w-7xl">
						<h1 className="text-center lg:text-6xl md:text-6xl reno:text-6xl sm:text-4xl xs:text-4xl xxs:text-4xl font-semibold text-heading mb-6">
							Media Mention
						</h1>
							...
							<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md">
								...
								<div className="p-5">
									<a href="https://www.bworldonline.com/sparkup/2023/07/10/532964/phl-based-edtech-company-among-world-economic-forums-technology-pioneers/#google_vignette">
										<h5 className="hover:text-skBlue text-sm">
											PHL-based edtech company among World Economic Forum’s
											Technology Pioneers
										</h5>
									</a>
								</div>
							...
							<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md">
								...
								<div className="p-5">
									<a href="https://www.weforum.org/agenda/2023/06/meet-the-world-economic-forum-s-technology-pioneers-of-2023/">
										<h5 className="hover:text-skBlue text-sm">
											Meet the World Economic Forum’s Technology Pioneers of
											2023
										</h5>
									</a>
								</div>
							...
							<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md">
								...
								<div className="p-5">
									<a href="https://newsbytes.ph/2021/05/12/ph-startup-pilots-gamified-edtech-platform-in-deped-makati-manila/?fbclid=IwAR2FNwyzni-Mp4FLjZ19hhqq9tyoqj8-QUP2rDv85GhLjCFpZdUg7bQezrM">
										<h5 className="hover:text-skBlue text-sm">
											PH startup pilots ‘gamified’ edtech platform in DepEd
											Makati, Manila
										</h5>
									</a>
								</div>
							...
							<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md">
								...
								<div className="p-5">
									<a href="https://businessmirror.com.ph/2021/06/26/stock-knowledge-deped-makati-join-forces-to-launch-edtech-platform/">
										<h5 className="hover:text-skBlue text-sm">
											Stock Knowledge, DepEd Makati join forces to launch EdTech
											platform
										</h5>
									</a>
								</div>
